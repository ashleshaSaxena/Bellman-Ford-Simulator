 ...
 * @author user
 */
public class camp_1 extends JFrame implements ActionListener {
    ...
    private void initComponents() {
		...
		panel.setPreferredSize(new Dimension(368,421));
                panel.setBorder(new TitledBorder("Bellman-Ford"));
                panel.setBackground(Color.WHITE);
                
                panel1 = new JPanel(new BorderLayout());
		panel1.setPreferredSize(new Dimension(368,421));
                panel1.setBorder(new TitledBorder("Floyd-Warshall"));
    ...
    private void setPanel() {
        ImageIcon image = new ImageIcon("C:\\Users\\user\\Desktop\\PBL\\bell_ip.png");
        JLabel label = new JLabel("", image, JLabel.CENTER);
        
        panel.add( label );
        
        ImageIcon image1 = new ImageIcon("C:\\Users\\user\\Desktop\\PBL\\bell_ip.png");
