 ...
 * @author user
 */
public class camp_4 extends JFrame implements ActionListener {
    ...
    private void initComponents() {
		...
		panel.setPreferredSize(new Dimension(368,421));
                panel.setBorder(new TitledBorder("Bellman-Ford (STEP: 3 shortest path)"));
                panel.setBackground(Color.WHITE);
                
                panel1 = new JPanel(new BorderLayout());
		panel1.setPreferredSize(new Dimension(368,421));
                panel1.setBorder(new TitledBorder("Floyd-Warshall (STEP: 3 shortest path)"));
    ...
    private void setPanel() {
        ImageIcon image = new ImageIcon("C:\\Users\\user\\Desktop\\PBL\\bell_3.png");
        JLabel label = new JLabel("", image, JLabel.CENTER);
        
        panel.add( label );
        
        ImageIcon image1 = new ImageIcon("C:\\Users\\user\\Desktop\\PBL\\ford_3.png");
