...
public class opFrame extends JFrame implements ActionListener{
    ...
    opFrame(int nodecount, int edgecount, int source, int[] distance,Edge[] edges) {
        n = nodecount;
        e = edgecount;
        s = source;
        ...
        //super("BELLMAN FORD ALGORITHM OUTPUT");
		setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
                setTitle("Output through Bellman");
