 ...
 * @author user
 */
public class camp_5 extends JFrame implements ActionListener {
    
    private JPanel panel;
     private JPanel panel1;
     private JPanel panel2;
     String[] nameOfTheButtons = { "FINISH"};
    ...
    private void initComponents() {
		...
		panel.setPreferredSize(new Dimension(368,421));
                panel.setBorder(new TitledBorder("Bellman-Ford (COMPLEXITY)"));
                panel.setBackground(Color.WHITE);
                
                panel1 = new JPanel(new BorderLayout());
		panel1.setPreferredSize(new Dimension(368,421));
                panel1.setBorder(new TitledBorder("Floyd-Warshall (COMPLEXITY)"));
    ...
    private void setPanel() {
        ImageIcon image = new ImageIcon("C:\\Users\\user\\Desktop\\PBL\\bell_co.png");
        JLabel label = new JLabel("", image, JLabel.CENTER);
        
        panel.add( label );
        
        ImageIcon image1 = new ImageIcon("C:\\Users\\user\\Desktop\\PBL\\ford_co.png");
