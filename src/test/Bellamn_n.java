...
public static void BellmanFord(Edge2 edges[], int edgecount, int nodecount, int source)
{
...
new opFrame_n(nodecount,edgecount,source,distance,edges).setVisible(true);
}
